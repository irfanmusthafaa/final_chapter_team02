  ...
  return (
    <Link className="no-underline" to={`/Detail/${props.class.classCode}`}>
      <div className="pb-3 flex justify-center items-center">
        <div className="flex flex-col bg-white border-2 w-[21rem] md:w-[22rem] rounded-3xl overflow-hidden max-h-64">
          <img
            src={props.class.thumbnailPicture}
            alt="img"
          ...
          <div className="px-4 mb-3 mt-1">
            <div className="flex justify-between items-center">
              <p className="text-purple-700 font-bold ">
                {props.class.categorys.categoryName}
              </p>
            ...
            <div className="flex space-x-3 text-xs mt-1">
              ...
              <div className="flex justify-center items-center gap-1 ">
                ...
                >
                  <g clipPath="url(#clip0_76_2206)">
                    <path
                      d="M3.33337 1.7334H9.33337V2.25007H3.33337V1.7334Z"
                      fill="#73CA5C"
                    />
                    <path
              ...
              <div className="flex justify-center items-center gap-1 ">
                ...
                <p className="font-semibold">
                  {props.class.totalDuration} Menit
                </p>
              </div>
            </div>
            <div>
