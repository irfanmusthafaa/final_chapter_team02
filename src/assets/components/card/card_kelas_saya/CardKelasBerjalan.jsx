...
export const CardKelasBerjalan = (props) => {
  ...
  return (
    ...
    >
      <div
        className="flex flex-col bg-white border-2 rounded-3xl overflow-hidden max-h-80 shadow-md mx-5 md:mx-0 "
        style={{ border: ".5px solid grey" }}
      >
        <img
          src={props.class.class.thumbnailPicture}
          alt="img"
          className="object-cover max-h-[7rem]"
        />
        <div className="px-4 mb-3 mt-1">
          <div className="flex justify-between items-center">
            <p className="text-purple-700 font-bold ">
              {props.class.class.categorys?.categoryName}
            </p>
          ...
          <p className="text-black font-bold mt-1">
            {props.class.class.className}
          </p>
          <p className="text-black text-sm mt-1">
            By : {props.class.class.author}
          </p>
            ...
            <div className="flex justify-center items-center gap-1 ">
              <div className="flex flex-row justify-center items-center">
                ...
                <p className="pl-[.1rem] font-semibold">
                  {props.class.class.totalDuration} Menit
                </p>
              </div>
            </div>
          </div>
