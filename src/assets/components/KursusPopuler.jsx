...
export const KursusPopuler = () => {
  ...
  const prevSlide = () => {
    setCurrentSlide(
      (prevSlide) => (prevSlide - 1 + Class.length) % Class.length
    );
  };
  ...
  const prev = () => {
    setCurrentCategory(
      (prevCategory) => (prevCategory - 1 + Category.length) % Category.length
    );
  };
    ...
    <>
      <div className="w-full flex flex-col justify-center items-center py-7 gap-3">
        <div className="flex w-4/5 justify-between items-center ">
          ...
          <a
            href="/"
            className="text-purple-700 no-underline font-bold text-sm hover:text-purple-900"
          >
            Lihat Semua
          </a>
        </div>
            ...
            <div className="slider-container">
              ...
              >
                {Class?.map((data) => (
                  ...
                  >
                    <img
                      src={data.thumbnailPicture}
                      placeholder="img"
                      className=" w-64 md:w-80 h-40 object-cover rounded-t-3xl"
                    />
                      ...
                      <div className="flex gap-2 justify-around text-xs mt-2">
                        <div className="flex flex-row justify-center items-center">
                          <ShieldCheckIcon
                            ...
                            style={{ color: "green" }}
                          />
                          <p className="pl-[.1rem] font-semibold text-purple-900">
                            {data.levelName}
                          </p>
                        </div>
                        <div className="flex flex-row justify-center items-center">
              ...
              {Class?.map((data) => (
                <div key={data.classCode} className="slide">
                  <div
                    key={data.classCode}
                    style={{ border: ".5px solid grey" }}
                    className="w-[16.8rem] gap-1 p-2 border-2 rounded-3xl pb-3"
                  >
                    <img
                      src={data.thumbnailPicture}
                      placeholder="img"
