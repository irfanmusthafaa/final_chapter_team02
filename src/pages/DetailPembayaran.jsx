...
import { faArrowCircleRight, faArrowLeft, faChevronDown, faChevronUp } from "@fortawesome/free-solid-svg-icons";
...
export const DetailPembayaran = () => {
  ...
  return (
    <div>
      ...
      {/* Modals */}
      <ModalDetailPembayaran open={open} setOpen={setOpen} />
          ...
          <div className="flex flex-col w-1/3">
            <button className="border-purple-700 rounded-xl h-fit flex flex-col gap-3 p-3 bg-transparent">
              ...
              <div className="flex flex-col bg-white border-2 rounded-3xl w-full shadow-lg">
                ...
                <div className="px-2 mt-2">
                  <div className="flex justify-between items-center">
                    <p className="text-purple-700 font-bold mb-2">{Class.categorys?.categoryName}</p>
                  ...
                  <div className="flex flex-col justify-start items-start gap-1">
                    <label className="text-black font-bold">{Class.className}</label>
                    <label className="text-black text-sm font-medium mb-2">By : {Class.author}</label>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full flex justify-center items-center">
                ...
                >
                  Bayar dan Ikuti Kelas <FontAwesomeIcon style={style} icon={faArrowCircleRight} />
                </div>
              </div>
            </button>
          </div>
