...
export const DetailKelasPage = () => {
  ...
  return (
    <div className='bg-white'>
        ...
        <div className='flex flex-col h-screens items-center bg-red-700'>
            <div className='flex flex-col h-screens mt-[4%]'>
                <div className='flex flex-row bg-purple-100 w-screen'>
                    <div className='w-[50%]'>
                ...
                <div className='bg-puple-700'>
                    <div className='flex flex-row'>
                        <div className='flex flex-col bg-white w-[50%] gap-5'>
                            <div className='bg-purple-500 h-[327px] rounded-2xl'>tes</div>
