...
export const DetailKelasPage = () => {
  ...
  const isClassCodeExists = learning.some(
    (learning) => learning.classCode === classCode
  );
            ...
            <div className=" w-[65%] mt-[3%]">
              ...
              <div className="px-5 my-4">
                ...
                <div>
                  <div className="flex justify-between items-center">
                    <CustomButtonDua
                      button_text="Join Grup Telegram"
                      iconPath={chat}
                      onClick={openTelegramLink}
                    />
                    {!isClassCodeExists && (
                      <CustomButtonDua
                        button_text="Tambah Kelas Saya"
                        iconPath={null}
                        onClick={AddClass}
                      />
                    )}
